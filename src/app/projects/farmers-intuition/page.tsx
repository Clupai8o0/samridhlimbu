...
const TIMELINE = [
  { date: 'Mar 2026 · h+0', title: 'Hack48 kickoff', body: '48-hour hackathon. Problem space: precision agriculture. Farmers make irrigation decisions based on gut feel and weather apps — neither is calibrated to soil or crop state.' },
  ...
  { date: 'Mar 2026 · h+18', title: '"Sage" voice assistant', body: 'ElevenLabs for voice synthesis. Farmers ask questions in natural language; Gemini handles intent and context; Sage speaks the answer back. Designed for use without looking at a screen.' },
  { date: 'Mar 2026 · h+48', title: 'Submission', body: 'FastAPI backend, two-layer ML engine, and voice assistant delivered in 48 hours.', current: true },
]
...
const DECISIONS = [
  ...
  ['gemini', 'fine-tuned local model', '48-hour constraint: no time to fine-tune. Gemini handles natural-language understanding out of the box; the ML engine handles domain prediction. Clear separation of responsibilities.'],
]
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '36px 28px' }}>
        ...
        <div style={{ padding: '22px 0', borderTop: '1px solid var(--accent)', borderBottom: '1px solid var(--border)', marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, marginBottom: 8, flexWrap: 'wrap' }}>
            ...
            <span className="pill" style={{ color: '#f59e0b', borderColor: 'rgba(245,158,11,0.3)', fontFamily: MONO }}>● hack48 · 48h</span>
          </div>
          <p style={{ fontFamily: SANS, fontSize: 14, color: 'var(--fg-dim)', lineHeight: 1.55, maxWidth: 580, margin: '0 0 16px' }}>
            AI precision irrigation advisory platform built in 48 hours at Hack48. Two-layer ML engine (prediction + recommendation) paired with a voice assistant named Sage — farmers ask questions in natural language and get actionable irrigation advice spoken back.
          </p>
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            <a href="https://github.com/clupai8o0/farmers-intuition" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ fontFamily: MONO, fontSize: 10 }}><Icon name="github" size={11} /> github</a>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 8, paddingTop: 18, borderTop: '1px solid var(--border)', flexWrap: 'wrap' }}>
          <a href="https://github.com/clupai8o0/farmers-intuition" target="_blank" rel="noopener noreferrer" className="btn" style={{ fontFamily: MONO, fontSize: 10 }}><Icon name="github" size={11} /> source</a>
