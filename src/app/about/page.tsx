  ...
  return (
    <PageShell>
      <div data-stagger style={{ maxWidth: 600, margin: '0 auto', padding: '40px 28px' }}>
        ...
        {/* Header */}
        <div data-stagger-item style={{ display: 'flex', gap: 18, alignItems: 'flex-start', marginBottom: 24 }}>
        ...
        {/* Bio */}
        <div data-reveal style={{ fontFamily: SANS, fontSize: 13.5, color: 'var(--fg-dim)', lineHeight: 1.7, display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
        ...
        {/* Visa note */}
        <div data-reveal style={{ padding: '12px 14px', border: '1px solid var(--border)', borderLeft: `2px solid ${GREEN}`, marginBottom: 24, fontFamily: SANS, fontSize: 12, lineHeight: 1.55, color: 'var(--muted)' }}>
        ...
        {/* Other */}
        <div data-reveal style={{ paddingTop: 16, borderTop: '1px solid var(--border)', fontFamily: SANS, fontSize: 12, color: 'var(--muted)', lineHeight: 1.6 }}>
          I also run{' '}
